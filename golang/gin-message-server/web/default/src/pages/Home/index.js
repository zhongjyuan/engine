                  ...
                  <Card.Content>
                    ...
                    <Card.Description>
                      ...
                      <p>
                        源码：
                        <a
                          href='https://github.com/zhongjyuan/gin-message-server'
                          target='_blank'
                        >
                          https://github.com/zhongjyuan/gin-message-server
                        </a>
                      </p>
                      <p>启动时间：{getStartTimeString()}</p>
                      <p>自从上次启动已发送消息数目：{statusState?.status?.messageCount}</p>
                      <p>自从上次启动新注册用户数目：{statusState?.status?.userCount}</p>
                    </Card.Description>
                  </Card.Content>
                </Card>
              </Grid.Column>
                ...
                <Card fluid>
                  <Card.Content>
                    ...
                    <Card.Description>
                      ...
                      <p>
                        全局消息持久化：
                        {statusState?.status?.messagePersistenceEnabled === true
                          ? '已启用'
                          : '未启用'}
                      </p>
                      <p>
                        全局消息渲染：
                        {statusState?.status?.messageRenderEnabled === true
                          ? '已启用'
                          : '未启用'}
                      </p>
                    </Card.Description>
