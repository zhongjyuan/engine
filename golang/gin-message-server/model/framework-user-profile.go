...
type UserProfileEntity struct {
	...
	SendEmailToOthers     int    `json:"send_email_to_others" gorm:"column:send_email_to_others;type:int;default:0"`         //
	SaveMessageToDatabase int    `json:"save_message_to_database" gorm:"column:save_message_to_database;type:int;default:0"` //
