...
func printHelp() {
	...
	fmt.Println("Gitee: https://gitee.com/zhongjyuan/gin-message-server")                                     // Gitee 地址
	fmt.Println("GitHub: https://github.com/zhongjyuan/gin-message-server")                                   // GitHub 地址
	fmt.Println("Usage: gin-message-server [--port <port>] [--log-dir <log directory>] [--version] [--help]") // 使用说明
}
