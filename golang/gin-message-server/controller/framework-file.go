...
import (
	...
	"zhongjyuan/gin-message-server/converter"
...
func DeleteFile(c *gin.Context) {
	...
	if err != nil || fileId == 0 {
		common.SendJSONResponse(c, http.StatusBadRequest, false, "文件删除失败,无效的参数！")
		return
	}
...
func DownloadFile(c *gin.Context) {
	...
	fileId, err := strconv.Atoi(fileIdStr)
	if err != nil || fileId == 0 {
		common.SendJSONResponse(c, http.StatusBadRequest, false, "文件下载失败,无效的参数！")
		return
	}
