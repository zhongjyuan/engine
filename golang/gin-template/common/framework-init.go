...
func printHelp() {
	...
	fmt.Println("Gitee: https://gitee.com/zhongjyuan/gin-template")                                     // Gitee 地址
	fmt.Println("GitHub: https://github.com/zhongjyuan/gin-template")                                   // GitHub 地址
	fmt.Println("Usage: gin-template [--port <port>] [--log-dir <log directory>] [--version] [--help]") // 使用说明
}
