...
func printHelp() {
	...
	fmt.Println("Gitee: https://gitee.com/zhongjyuan/gin-file-server")                                     // Gitee 地址
	fmt.Println("GitHub: https://github.com/zhongjyuan/gin-file-server")                                   // GitHub 地址
	fmt.Println("Usage: gin-file-server [--port <port>] [--log-dir <log directory>] [--version] [--help]") // 使用说明
}
