const defaultConfig = {
	...
	prompt: {
		type: "请选择渠道类型",
		name: "请为渠道命名",
		baseUrl: "可空，请输入中转API地址，例如通过cloudflare中转",
		key: "请输入渠道对应的鉴权密钥",
		other: "",
		models: "请选择该渠道所支持的模型",
		modelMapping: '请输入要修改的模型映射关系，格式为：api请求模型ID:实际转发给渠道的模型ID，使用JSON数组表示，例如：{"gpt-3.5": "gpt-35"}',
...
const typeConfig = {
	3: {
		...
		prompt: {
			baseUrl: "请填写AZURE_OPENAI_ENDPOINT",
