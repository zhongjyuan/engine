...
//   - meta *relaymodel.AIRelayMeta: 中继元数据对象。
//
// 输出参数：
//   - 无。
func SetupCommonRequestHeader(c *gin.Context, req *http.Request, meta *relaymodel.AIRelayMeta) {
...
func DoRequestHelper(a Adaptor, c *gin.Context, meta *relaymodel.AIRelayMeta, requestBody io.Reader) (*http.Response, error) {
	// 获取完整的请求 URL。
