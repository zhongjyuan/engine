		...
		<>
			<Formik
				initialValues={{
					...
					verificationCode: showEmailVerification ? "" : undefined,
					submit: null,
				}}
				validationSchema={Yup.object().shape({
					...
					verificationCode: showEmailVerification ? Yup.string().max(255).required("验证码是必填项") : Yup.mixed(),
				})}
						...
						{showEmailVerification && (
							<>
								...
								<FormControl fullWidth error={Boolean(touched.verificationCode && errors.verificationCode)} sx={{ ...theme.typography.customInput }}>
									<InputLabel htmlFor="outlined-adornment-verificationCode-register">验证码</InputLabel>
									<OutlinedInput
