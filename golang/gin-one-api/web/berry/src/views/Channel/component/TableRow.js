	...
	return (
		<>
			<TableRow tabIndex={item.id}>
				...
				<TableCell>
					<ResponseTimeLabel testTime={responseTimeData.testTime} responseTime={responseTimeData.responseTime} handle_action={handleResponseTime} />
				</TableCell>
				<TableCell>
