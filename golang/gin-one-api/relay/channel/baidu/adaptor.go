...
// GetRequestURL 方法用于根据 RelayMeta 获取请求的完整 URL。
//
// 输入参数：
...
func (a *Adaptor) ConvertRequest(c *gin.Context, relayMode int, request *relayModel.GeneralOpenAIRequest) (interface{}, error) {
	if request == nil {
