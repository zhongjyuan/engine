...
func printHelp() {
	...
	fmt.Println("Gitee: https://gitee.com/zhongjyuan/gin-one-api")                                     // Gitee 地址
	fmt.Println("GitHub: https://github.com/zhongjyuan/gin-one-api")                                   // GitHub 地址
	fmt.Println("Usage: gin-one-api [--port <port>] [--log-dir <log directory>] [--version] [--help]") // 使用说明
}
