 ...
 */
export default class ClavierManagement {
	/**音频加载完成 */
	audioLoad = false;
	/**按键音频 */
	keydownAudio = null;
	...
	loadAudio(options) {
		if (!this.audioLoad) {
			this.keydownAudio = new AudioManagement("./resources/audios/key-down.mp3", false);
			this.keyUpAudio = new AudioManagement("./resources/audios/key-down.mp3", false);
