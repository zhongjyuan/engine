...
import { isEmpty, isFunction, isString } from "./utils/default";
...
export default (() => {
	...
	function on(eventName, callback) {
		...
		if (!window.zhongjyuan.runtime.event_handles[eventName]) window.zhongjyuan.runtime.event_handles[eventName] = [];

		window.zhongjyuan.runtime.event_handles[eventName].push(callback || function () {});
	}
	...
	function emit(eventName) {
		...
		var handles = window.zhongjyuan.runtime.event_handles && window.zhongjyuan.runtime.event_handles[eventName];
	...
	function off(eventName) {
		eventName && delete window.zhongjyuan.runtime.event_handles[eventName];
	}
