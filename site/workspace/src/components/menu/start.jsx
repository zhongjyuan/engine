...
import { StartPane, SearchPane } from "@/components/pane";
...
export const StartMenu = () => {
	...
	return (
		<div className="start-menu dpShad" data-align={align} data-hide={startMenu.hide} style={{ "--slice": "start" }}>
			{startMenu.menu ? <StartPane menu={startMenu} /> : <SearchPane menu={startMenu} query={query} setQuery={setQuery} match={match} />}
		</div>
	);
};
