...
/**
 * SVG图标组件，用于渲染一个简单的房子图标。
 *
 * @param {object} props - 组件属性
 * @returns {JSX.Element} - 返回SVG图标元素
 */
...
export const info = (props) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" {...props}>
			...
			<path
				fill="#0078d7"
				d="M27.34 3.45c7.1-1.02 14.61.32 20.59 4.4 8.03 5.14 13.14 14.6 12.91 24.15.27 10.76-6.27 21.26-15.95 25.91-9.25 4.63-21.06 3.84-29.49-2.22-8.32-5.6-13.09-15.91-12.18-25.88C3.8 16.8 14.5 5.29 27.34 3.45"
			/>
			{/* 白色填充部分 */}
...
export const mark = (props) => {
	return (
		<svg xmlns="https://www.w3.org/2000/svg" width={76} height={95} viewBox="0 0 760 950" {...props}>
			<path
