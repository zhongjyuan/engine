if (typeof ZHONGJYUAN != "undefined") {
	ZHONGJYUAN.addOnReady(function() {
		var lang =
			ZHONGJYUAN.static.lang === "zh-cn" || ZHONGJYUAN.static.lang === "zh-tw"
				? {
						Mon: "星期一",
						MonShort: "一",
						Tues: "星期二",
		...
		function showDate() {
			...
			if (_setmonth === 0) {
				...
				str =
					_fn_layout(_setyear, _setmonth - 1, _setdate) + _fn_layout(_setyear, _setmonth, _setdate) + _fn_layout(_setyear, _setmonth + 1, _setdate);
			}
			oDays.innerHTML = str;
			_aStrong[0].innerHTML = _setyear + "/" + (_setmonth + 1);
		}
