...
(function() {
	...
	(window.requestAnimationFrame = (function() {
		...
		String.getByteLength ||
			(String.getByteLength = function(e) {
				var t,
					n = 0,
					r = e || "",
					i = r.length;
							...
							m.canvas.pass(this.cacheId, this.width * 3, this.height),
								this.imageId == ""
									? (this.bgColor != "" &&
									  ...
									  this.bgStroke != "" &&
											m.canvas
												.strokeStyle(this.bgStroke)
												.strokeRect(1, 1, this.width - 2, this.height - 2)
												.strokeRect(this.width + 1, 1, this.width - 2, this.height - 2)
												.strokeRect(this.width * 2 + 1, 1, this.width - 2, this.height - 2))
									: m.canvas
											.drawImage(this.imageId, this.sx, this.sy, this.width, this.height, 0, 0, this.width, this.height)
							...
							if (this.value != "") {
								...
								this.stroke != "" &&
									m.canvas
										...
										.fillText(this.value, t - 1, n)
										.fillText(this.value, t, n - 1)
										.fillText(this.value, t + 1, n)
										.fillText(this.value, t, n + 1)
										.fillText(this.value, t + this.width - 1, n)
										.fillText(this.value, t + this.width, n - 1)
										.fillText(this.value, t + this.width + 1, n)
										.fillText(this.value, t + this.width, n + 1)
										.fillText(this.value, t + this.width * 2 - 1, n)
										.fillText(this.value, t + this.width * 2, n - 1)
										.fillText(this.value, t + this.width * 2 + 1, n)
										.fillText(this.value, t + this.width * 2, n + 1),
									m.canvas
										.fillStyle(this.color)
										.fillText(this.value, t, n)
										.fillStyle(this.hColor)
										.fillText(this.value, t + this.width, n)
										.fillStyle(this.deColor)
										.fillText(this.value, t + this.width * 2, n),
									(e = t = n = null);
							}
		...
		i = {
			...
			getOffsetX: function(e) {
				return (
					...
					(e.changedTouches && e.changedTouches[0]
						? e.changedTouches[0].clientX - i.getCanvasDom().offsetLeft
						: e.clientX - i.getCanvasDom().offsetLeft) ||
					0
				);
			},
			getOffsetY: function(e) {
				return (
					e.offsetY ||
					(e.changedTouches && e.changedTouches[0]
						? e.changedTouches[0].clientY - i.getCanvasDom().offsetTop
						: e.clientY - i.getCanvasDom().offsetTop) ||
					0
				);
			},
			keydown: function(e) {
				...
				n.event.keyDownGo && n.event.keys[t] != undefined && (n.event.keys[t] = !0),
					...
					n.event.keyPressCtrl[t] &&
						n.event.keyPressedGo &&
						(n.event.pressedKey[t] != undefined && (n.event.pressedKey[t] = !0), (n.event.keyPressCtrl[t] = !1)),
			...
			loadingCallBack: function(e, t, r) {
				var i = m.canvas.screen.getWidth(),
					...
					l = parseInt((e / t) * 100) + "%";
				m.canvas
					.fillStyle(n.canvas.bgColor)
					.fillRect(0, 0, i, s)
					.fillStyle("#00FFFF")
					.fillRect(a, f, parseInt((e / t) * o), u)
					.fillStyle("#FFF")
					.fillText("loading " + r, 5, s - 10)
					.fillText(l, i - m.canvas.measureText(l).width - 5, s - 10),
					(i = s = o = u = a = f = l = null);
			},
	...
	link = {
		init: function(e, t) {
			return (
				!e && !t
					? ((this.version = 1), this.request.init(), this.canvas.initDevice(), this.localStorage.init(), this.sessionStorage.init())
					: ((n.canvas.defaultWidth = e), (n.canvas.defaultHeight = t)),
				this
			);
		},
		extend: t,
				...
				if ((i = arguments[t]) != null)
					for (var s in i) {
						var o = e[s],
							u = i[s];
						if (e === u) continue;
						r && u && typeof u == "object" && !u.nodeType
							? (e[s] = this.objExtend(r, o || (u.length != null ? [] : {}), u))
							: u !== undefined && (e[s] = u);
					}
			return e;
		},
		...
		comm: {
			...
			rect2CircleCollision: function(e, t, n, r, i, s, o) {
				var u = !1;
				return (
					(u = this.circleCollision(e, t, 1, i, s, o)) ||
		...
		main: function(e) {
			...
			return (
				s == "ipad" || s == "iphone"
					? ((n.event.focused = !0), window.addEventListener("pageshow", i.pageFocus, !1), window.addEventListener("pagehide", i.pageUnFocus, !1))
		...
		pause: function() {
			return (
				n.system.playTimer &&
					((n.system.isPause = !0), (n.system.rafRun = null), cancelAnimationFrame(n.system.playTimer), (n.system.playTimer = null)),
				this
			);
		},
		gameFlow: {
		...
		canvas: {
			...
			initDevice: function() {
				return (
					(h = i.getDeviceConfig()), (n.canvas.device = h.device), (n.canvas.fps = h.fps), (n.canvas.touch = h.touch), (n.canvas.zoom = h.zoom), this
				);
			},
			pass: function(e, t, r) {
				var i, o;
				return (
					!e || e == "" ? (i = n.canvas.defaultId) : (i = e),
					n.canvas.ctxs[i] ||
						((o = this.base().getDom(i) || document.createElement("canvas")),
			...
			del: function(e) {
				return (
					n.canvas.ctxs[e] && ((n.canvas.ctxs[e] = null), delete n.canvas.ctxs[e], (n.canvas.cavansDoms[e] = null), delete n.canvas.cavansDoms[e]),
					this
				);
			},
			...
			screen: {
				...
				setWidth: function(e) {
					return (
						(n.canvas.defaultWidth = e), c && ((c.width = n.canvas.defaultWidth), (c.style.width = c.width + "px"), (p = parseInt(c.width))), this
					);
				},
				getHeight: function() {
					return d;
			...
			setColor: function(e, t, n) {
				return (
					n == null
						? ((u.fillColor = e), (u.strokeColor = t ? t : e))
						: ((u.fillColor = "rgb(" + e + ", " + t + ", " + n + ")"), (u.strokeColor = u.fillColor)),
			...
			drawImage: function(e, t, r, u, a, f, l, c, h, p) {
				...
				if (d.refreshed) this.drawCache(e, t, r, u, a, f, l, c, h, p);
					...
					c != null && ((t = t < 0 ? 0 : t), (c = c <= 0 ? 0.1 : c)),
						h != null && ((r = r < 0 ? 0 : r), (h = h <= 0 ? 0.1 : h)),
						u != null && c != null && (u = u <= 0 ? 0.1 : t + u <= d.width ? u : d.width - t),
						a != null && h != null && (a = a <= 0 ? 0.1 : r + a <= d.height ? a : d.height - r),
						d.loaded &&
							(u
								? a
									? p
										? ((o = i.getAnchor(f, l, c, h, p)), s.drawImage(d, t, r, u, a, o.x, o.y, c, h))
			...
			drawString: function(e, t, i, o, u, a, f, c) {
				...
				return (
					u &&
						(a ? (l.fillStyle = a) : (l.fillStyle = "#000000"),
						f ? (l.strokeStyle = f) : (l.strokeStyle = "#CCCCCC"),
						this.fillStyle(l.strokeStyle)
							.fillText(e, l.x + 1, l.y + 1, c)
		...
		audio: {
				...
				if (i)
					try {
						i.__timeupdateCallBack__ ||
							i.addEventListener(
								"timeupdate",
								(i.__timeupdateCallBack__ = function() {
			...
			del: function(e) {
				...
				return (
					t &&
						t.__timeupdateCallBack__ &&
						(t.pause(), t.removeEventListener("timeupdate", t.__timeupdateCallBack__, !1), (n.audio.audios[e] = null), delete n.audio.audios[e]),
					(t = null),
					this
				);
			},
		...
		events: {
			keyDown: function(e) {
				return (
					n.event.keyDownGo || (n.event.keyDownGo = !0),
	...
	define("lib/action", ["lib/link"], function(e) {
		...
		(e.action = {}),
				...
				if (n) {
					...
					if (this._path.length > 0) {
						...
						this.svx != null &&
							this.svy != null &&
							(this._skipMoveDs ||
								(this.setSprite(this._stopedAction || this._stopDs[(this.dsIndex = t(this.svx, this.svy))]), (this._stopedAction = null)),
						...
						(u = this.rects[r[p][0]][r[p][1]]),
							...
							o == e.trans.TRANS_NONE
								? s.drawImage(
										...
										u[2],
										u[3],
										this.zoom == 1 ? ~~(this.x + this.dx + r[p][2] * this.zoom) : this.x + this.dx + r[p][2] * this.zoom,
										this.zoom == 1 ? ~~(this.y + this.dy + r[p][3] * this.zoom) : this.y + this.dy + r[p][3] * this.zoom,
										u[2] * this.zoom,
										u[3] * this.zoom
								  )
								: this.zoom == 1
								? s.drawRegion(a, u[0], u[1], u[2], u[3], o, ~~(this.x + this.dx - (r[p][2] + u[2])), ~~(this.y + this.dy + r[p][3]))
								: s.drawRegionAndZoom(
										a,
										u[0],
										u[1],
										...
										u[3],
										o,
										this.x + this.dx - (r[p][2] + u[2]) * this.zoom,
										this.y + this.dy + r[p][3] * this.zoom,
										null,
										u[2] * this.zoom,
										u[3] * this.zoom
								  ),
							!f.loaded &&
								f.bench &&
								s.drawImage(
									f.bench.id || f.benchId,
									f.bench.sx || 0,
									f.bench.sy || 0,
									f.bench.sw || f.bench.w,
									f.bench.sh || f.bench.h,
									~~(this.x + this.dx - ((f.bench.w * this.zoom) >> 1)),
									~~(this.y + this.dy - f.bench.h * this.zoom),
									f.bench.w * this.zoom,
									f.bench.h * this.zoom
								);
			...
			(e.action.Role.prototype.collision = function(t, n, r) {
				...
				var i = n || "aR",
					...
					u;
				return (
					i == "aR" ? (o = this.getAttackRect()) : i == "bR" && (o = this.getBodyRect()),
			...
			(e.action.Role.prototype.collisionInput = function(t, n, r, i, s) {
				var o = s || "aR",
					u;
				return (
					o == "aR" ? (u = this.getAttackRect()) : o == "bR" && (u = this.getBodyRect()),
			...
			(e.action.Role.prototype.circleCollisionInput = function(t, n, r, i) {
				var s = i || "aR",
					o;
				return (
					s == "aR" ? (o = this.getAttackRect()) : s == "bR" && (o = this.getBodyRect()),
			...
			(e.action.Role.prototype.polygonSATCollision = function(t, n, r) {
				...
				var i = n || "aR",
					...
					u;
				return (
					i == "aR" ? (o = this.polyAR) : i == "bR" && (o = this.polyBR),
			...
			(e.action.Sprite.prototype.setFrame = function(e) {
				return (
					(this.current = e >= this.frames.length ? this.frames.length - 1 : e > 0 ? e : 0),
			...
			(e.action.Sprite.prototype.nextFrame = function() {
				return !this.loop && this.endFrame()
					? this
					: (this.frames.length > 0 &&
							(this.runStep <= 0
								? (this.loop ? (this.current++, (this.current %= this.frames.length)) : this.current < this.frames.length - 1 && this.current++,
								  this.getFrame().step ? (this.runStep = this.getFrame().step) : (this.runStep = this.step))
								: this.runStep--),
					  this);
			}),
			(e.action.Sprite.prototype.preFrame = function() {
				return (
					this.frames.length > 0 &&
						(this.runStep <= 0
							? (this.loop ? (this.current--, this.current < 0 && (this.current = this.frames.length - 1)) : this.current > 0 && this.current--,
							  this.getFrame().step ? (this.runStep = this.getFrame().step) : (this.runStep = this.step))
							: this.runStep--),
					this
				);
		...
		var r,
			i = function(e) {
				return (
					e.sprites.length > 0
						? e.sprites[0].frames.length > 0 &&
						  (e.sprites[0].runStep <= 0
								? ((e.sprites[0].runStep = e.sprites[0].step),
								  (r = e.sprites[0].frames.shift()),
								  e.sprites[0].frames.length == 0 && e.sprites.shift())
								: ((r = e.sprites[0].getFrame()), e.sprites[0].runStep--))
						: (r = null),
					r
				);
			};
		return (
			(e.action.Fragment = function(e) {
				this.sprites = e || [];
			}),
			...
			init: function() {
				...
				e.run(function() {
					...
					e.canvas
						.fillStyle("#000")
						.font("30px Arial")
						.fillText(c, i - e.canvas.measureText(c).width - 20, 50),
						(t = null);
				})
					.menu(function() {
						e.canvas
							...
							e.buttonLayout.released("difficulty1")
								? ((l.moduleName = "我的成绩"), hideAd(), c(2))
								: e.buttonLayout.released("difficulty2")
								? ((l.moduleName = "噩梦模式"), c(3))
								: e.buttonLayout.released("difficulty3")
								? ((l.moduleName = "地狱模式"), c(4))
								: e.buttonLayout.released("difficulty4")
								? ((l.moduleName = "炼狱模式"), c(5))
								: e.buttonLayout.released("rank") && dp_Ranking();
					})
					.zone(function() {
						e.canvas
							.fillStyle("#90EE90")
							...
							.fillStyle("#000")
							.drawString("最佳:" + a(l.bestTime, "秒"), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑"),
						...
						Scene: e.extend(
							...
							null,
							{
								...
								touchStart: function(t, n) {
									return this.host.endPath()
										? (e.comm.collision(t, n, 1, 1, this.x, this.baseY - this.height, this.width, this.height) &&
												this.host.setPath([
													[0, -20],
													[0, -20],
													[0, -20],
	...
	require(["lib/link", "index"], function(e, t) {
		e.init(window.innerWidth, window.innerHeight)
			.pushImage(
				[
					{
						id: "logo",
						src: "image/ygdbns.jpg",
					},
					{
						id: "btns1",
						src: "image/gdyx.png",
