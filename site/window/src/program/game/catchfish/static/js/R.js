...
(function() {
	...
	R.sources = [
		//{id:"cannon", size:50, src:"image/cannon-hd.png?"+Math.random()},
		//{id:"fish", size:50, src:"image/fish-hd.png?"+Math.random()},
		//{id:"shark", size:50, src:"image/shark-hd.png?"+Math.random()},
		{ id: "mainbg", size: 456, src: "image/game_bg_2_hd.jpg?" + Math.random() },
		{ id: "bottom", size: 50, src: "image/bottom.png?" + Math.random() },
		{ id: "fish1", size: 6, src: "image/fish1.png?" + Math.random() },
		{ id: "fish2", size: 16, src: "image/fish2.png?" + Math.random() },
		{ id: "fish3", size: 11, src: "image/fish3.png?" + Math.random() },
		{ id: "fish4", size: 15, src: "image/fish4.png?" + Math.random() },
		{ id: "fish5", size: 43, src: "image/fish5.png?" + Math.random() },
		{ id: "fish6", size: 45, src: "image/fish6.png?" + Math.random() },
		{ id: "fish7", size: 80, src: "image/fish7.png?" + Math.random() },
		{ id: "fish8", size: 100, src: "image/fish8.png?" + Math.random() },
		{ id: "fish9", size: 104, src: "image/fish9.png?" + Math.random() },
		{ id: "fish10", size: 121, src: "image/fish10.png?" + Math.random() },
		{ id: "shark1", size: 287, src: "image/shark1.png?" + Math.random() },
		{ id: "shark2", size: 382, src: "image/shark2.png?" + Math.random() },
		{ id: "cannon1", size: 11, src: "image/cannon1.png?" + Math.random() },
		{ id: "cannon2", size: 11, src: "image/cannon2.png?" + Math.random() },
		{ id: "cannon3", size: 11, src: "image/cannon3.png?" + Math.random() },
		{ id: "cannon4", size: 13, src: "image/cannon4.png?" + Math.random() },
		{ id: "cannon5", size: 13, src: "image/cannon5.png?" + Math.random() },
		{ id: "cannon6", size: 15, src: "image/cannon6.png?" + Math.random() },
		{ id: "cannon7", size: 17, src: "image/cannon7.png?" + Math.random() },
		{ id: "bullet", size: 8, src: "image/bullet.png?" + Math.random() },
		{ id: "web", size: 93, src: "image/web.png?" + Math.random() },
		{ id: "numBlack", size: 1, src: "image/number_black.png?" + Math.random() },
		{ id: "coinAni1", size: 19, src: "image/coinAni1.png?" + Math.random() },
		{ id: "coinAni2", size: 22, src: "image/coinAni2.png?" + Math.random() },
		{ id: "coinText", size: 16, src: "image/coinText.png?" + Math.random() },
	];
	...
	R.initResources = function() {
		...
		var fish2 = {
			...
			mixin: { coin: 3, captureRate: 0.5, maxNumGroup: 6, minSpeed: 0.5, maxSpeed: 1.2, regX: 58, regY: 20, useFrames: true, interval: 10 },
		};
		...
		var fish4 = {
			...
			mixin: { coin: 8, captureRate: 0.4, maxNumGroup: 6, minSpeed: 0.5, maxSpeed: 1.2, regX: 57, regY: 18, useFrames: true, interval: 10 },
		};
		...
		var fish6 = {
			...
			mixin: { coin: 20, captureRate: 0.3, maxNumGroup: 3, minSpeed: 0.5, maxSpeed: 1.2, regX: 65, regY: 25, useFrames: true, interval: 10 },
		};
		...
		var fish8 = {
			...
			mixin: { coin: 40, captureRate: 0.2, maxNumGroup: 3, minSpeed: 0.5, maxSpeed: 0.8, regX: 90, regY: 50, useFrames: true, interval: 10 },
		};
		...
		var fish10 = {
			...
			mixin: { coin: 60, captureRate: 0.1, maxNumGroup: 2, minSpeed: 0.5, maxSpeed: 0.8, regX: 100, regY: 80, useFrames: true, interval: 10 },
		};
