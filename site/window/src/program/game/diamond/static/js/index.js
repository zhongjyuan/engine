$(document).ready(function(e) {
	...
	function xuan() {
		...
		if (le == 0) {
			...
			yc.push([200, 400, 40, 10, 0.05, 5, 1, false]);
			yc.push([300, 400, 40, 10, 0.05, 5, 1, false]);
			yc.push([400, 400, 40, 10, 0.05, 5, 1, false]);
			chu = [560, 280, mr, mr];
			x = 20;
			y = 400;
		} else if (le == 6) {
			...
			yc.push([320, 430, 60, 10, 0.05, 5, 1, false]);
			yd.push([20, 401, 60, 10, "y", 200, 450, 5, -1, 0, 3]);
			yd.push([170, 401, 60, 10, "y", 100, 450, 6, -1, 0, 6]);
			yd.push([500, 501, 50, 10, "y", 450, 550, 2, -1, 0, 0.5]);
			...
			bu.push([0, 50, 350, 50]);
			yc.push([120, 240, 50, 10, 0.05, 5, 1, false]);
			yc.push([180, 160, 50, 10, 0.05, 5, 1, false]);
			yc.push([270, 220, 50, 10, 0.05, 5, 1, false]);
			...
			yc.push([150, 400, 50, 10, 0.05, 5, 1, false]);
			yc.push([270, 330, 50, 10, 0.05, 5, 1, false]);
			yc.push([400, 260, 50, 10, 0.05, 5, 1, false]);
			...
			yc.push([200, 100, 20, 10, 0.05, 5, 1, false]);
			yc.push([380, 100, 20, 10, 0.05, 5, 1, false]);
			...
			bc.push([540, 400, 60, 60, 0.01, 1, 1]);
			yc.push([0, 150, 50, 10, 0.05, 5, 1, false]);
			yc.push([0, 250, 50, 10, 0.05, 5, 1, false]);
			yc.push([0, 350, 50, 10, 0.05, 5, 1, false]);
			yc.push([0, 450, 50, 10, 0.05, 5, 1, false]);
			yc.push([50, 500, 50, 10, 0.05, 5, 1, false]);
			yc.push([50, 400, 50, 10, 0.05, 5, 1, false]);
			yc.push([50, 300, 50, 10, 0.05, 5, 1, false]);
			yc.push([50, 200, 50, 10, 0.05, 5, 1, false]);
			...
			bd.push([150, 450, 40, 90, "y", 400, 500, 4, 1, 0, 0.2]);
			bd.push([350, 306, 40, 90, "y", 300, 400, 5, 1, 0, 0.2]);
		...
		for (var i = 0; i < yd.length; i++) {
			if (yd[i][4] == "x") {
				...
				if (x + mr > yd[i][0] && x < yd[i][2] + yd[i][0] && parseInt(y + mr) <= parseInt(yd[i][11]) && parseInt(y + mr + v) >= yd[i][1]) {
					...
					x + mr > yd[i][0] &&
					x < yd[i][2] + yd[i][0] &&
					parseInt(y) >= yd[i][1] + yd[i][3] &&
					parseInt(y + v) <= yd[i][1] + yd[i][3] + yd[i][9]
				) {
					v = 0;
					y = yd[i][1] + yd[i][3];
				}
