...
$("#square-root").on("click", function() {
	...
	// radicand is a single number
		...
		display1.operation.endsWith("0") ||
		display1.operation.endsWith("1") ||
		display1.operation.endsWith("2") ||
		display1.operation.endsWith("3") ||
		display1.operation.endsWith("4") ||
		display1.operation.endsWith("5") ||
		display1.operation.endsWith("6") ||
		display1.operation.endsWith("7") ||
		display1.operation.endsWith("8") ||
		display1.operation.endsWith("9") ||
		display1.operation.endsWith(".")
	) {
		index = display1.operation.length - 1;
		for (i = display1.operation.length - 2; i > -1; i--) {
			if (
				display1.operation.charAt(i) === "0" ||
				display1.operation.charAt(i) === "1" ||
				display1.operation.charAt(i) === "2" ||
				display1.operation.charAt(i) === "3" ||
				display1.operation.charAt(i) === "4" ||
				display1.operation.charAt(i) === "5" ||
				display1.operation.charAt(i) === "6" ||
				display1.operation.charAt(i) === "7" ||
				display1.operation.charAt(i) === "8" ||
				display1.operation.charAt(i) === "9" ||
	...
	index = $("#display1")
		.val()
		.lastIndexOf(radicand);

	radicand = $("#display1")
		.val()
		.substring(index, $("#display1").val().length);
...
$("#backspace").on("click", function() {
	if (typeof display1.operation.slice === "function") display1.operation = display1.operation.slice(0, display1.operation.length - 1);
	$("#display1").val(
		$("#display1")
			.val()
