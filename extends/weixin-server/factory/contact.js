...
var contactProto = {
  ...
  */
	init: function init(instance) {
		...
		this.NickName = (0, _global.convertEmoji)(this.NickName);
		this.RemarkName = (0, _global.convertEmoji)(this.RemarkName);
		this.DisplayName = (0, _global.convertEmoji)(this.DisplayName);
